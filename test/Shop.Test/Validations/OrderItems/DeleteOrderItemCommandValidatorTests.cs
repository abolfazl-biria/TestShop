...
public class DeleteOrderItemCommandValidatorTests
{
    private readonly DeleteOrderItemCommandValidator _validator = new();

    [Fact]
    public void Should_Have_Validation_Error_When_ProductId_Is_Zero()
    {
        // Arrange
        var command = new DeleteOrderItemCommand { ProductId = 0, CustomerId = 1 };
    ...
    {
        // Arrange
        var command = new DeleteOrderItemCommand { ProductId = 1, CustomerId = 0 };
    ...
    {
        // Arrange
        var command = new DeleteOrderItemCommand { ProductId = 1, CustomerId = 1 };
